...
const Contact = () => {
    ...
    const handleSubmit = (e) => {
        ...
        emailjs.send('service_p67kffj', 'template_f99d09f',
        {
            form_name: form.name,
            to_name: 'Arun',
            form_email: form.email,
            to_email: 'arunmauryaam9@gmail.com',
      ...
      className='flex-[0.75] bg-black-100 p-8 rounded-xl '>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className='mt-12 flex flex-col gap-8'>
            ...
            <label className='flex flex-col'>
                ...
                <textarea rows={7}  name='message' value={form.message} onChange={handleChange} placeholder="What do you want to say ?" className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg border-none font-medium' />
            </label>
